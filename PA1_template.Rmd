...
Mean Total steps taken a day: `r format(round(meanTotalDays,0), nsmall = 0) `  
Median Total steps taken a day: `r medianTotalDays `  
...
```
The 5 minute inteval of the day with the most steps is: `r format(round(maxInterval,0), nsmall = 0)  `  
...
```
Mean Total steps taken a day: `r format(round(meanNoNATotalDays,0), nsmall = 0) `  
Median Total steps taken a day: `r format(round(medianNoNATotalDays,0), nsmall = 0) `  
Number if NA before replacing them: `r NumberOfNA`  
Numer of NA after replacing them: `r NumberOfNA_afterReplacement`  
